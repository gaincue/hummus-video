...
const HelloWorld = ({titleText, titleColor}) => {
	...
	const opacity = remotion_1.interpolate(
		frame,
						...
						{style: {opacity}},
						{
							children: [
								jsx_runtime_1.jsx(
									remotion_1.Sequence,
									Object.assign(
										{from: 0, durationInFrames: videoConfig.durationInFrames},
										{
								...
								jsx_runtime_1.jsx(
									remotion_1.Sequence,
									Object.assign(
										{from: transitionStart + 10, durationInFrames: Infinity},
										{
											children: jsx_runtime_1.jsx(
												Title_1.Title,
												{titleText: titleText, titleColor: titleColor},
												void 0
											),
										}
									),
								...
								jsx_runtime_1.jsx(
									remotion_1.Sequence,
									Object.assign(
										{from: transitionStart + 50, durationInFrames: Infinity},
										{
											children: jsx_runtime_1.jsx(
												Subtitle_1.Subtitle,
												{},
